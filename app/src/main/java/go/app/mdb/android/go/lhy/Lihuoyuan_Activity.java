package go.app.mdb.android.go.lhy;
...
import go.app.mdb.android.go.lixian.LixinaMainActivity;
...
public class Lihuoyuan_Activity extends AppCompatActivity  implements AbsListView.OnScrollListener  {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lihuoyuan);
...
//                            if (totalCount<xiala_coint){
                                ...
                                myAdapter = new MyAdapter(Lihuoyuan_Activity.this,listenety,onClickListener);
...
//                            }
                            ...
                            Toast.makeText(Lihuoyuan_Activity.this,"暂无数据",Toast.LENGTH_SHORT).show();
                        }
...
//                            }.start();
    ...
    private View.OnClickListener onClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
          ...
          //  Toast.makeText(Lihuoyuan_Activity.this,"点击的是第"+pos,Toast.LENGTH_SHORT).show();
        }
    };
    /***
...
//        act2.setAdapter(adapter_2);
        adapter_3 = new ArrayAdapter<String>(Lihuoyuan_Activity.this, R.layout.item_ac, R.id.tv_1, list_3);
        act3.setAdapter(adapter_3);
        adapter_4 = new ArrayAdapter<String>(Lihuoyuan_Activity.this,  R.layout.item_ac, R.id.tv_1, list_4);
...
//        list_2 .add("222666");
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(String s, Call call, Response response) {
                        ...
                        if (fz.getState().equals("1")){
                            ...
                            Toast.makeText(Lihuoyuan_Activity.this,"获取网络数据失败，请稍后重试",Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    ...
    private void addinfo_spinner(){
        ...
        stringArrayAdapter = new ArrayAdapter<String>(Lihuoyuan_Activity.this,R.layout.spinner_item2,name5);
        ...
        spinner5.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (name5_id[i].equals("a")){
                    ...
                    ArrayAdapter<String> emptyadapter = new ArrayAdapter<String>(Lihuoyuan_Activity.this, R.layout.spinner_item2, empty);
                            ...
                            .execute(new StringCallback() {
                                ...
                                public void onSuccess(String s, Call call, Response response) {
                                    ...
                                    if (fl.getState().equals("1")) {
                                        ...
                                        Toast.makeText(Lihuoyuan_Activity.this, "此分类暂无分组数据！", Toast.LENGTH_SHORT).show();
    ...
    private void addinfo_spinner2(){
        stringArrayAdapter2 = new ArrayAdapter<String>(Lihuoyuan_Activity.this,R.layout.spinner_item2,name6);
        ...
        btn_chaxun.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (act1.getText().toString().equals("")&&act2.getText().toString().equals("")&&act3.getText().toString().equals("")&&
                    ...
                    //没有写入信息查询所有
                    init();
// Toast.makeText(Lihuoyuan_Activity.this,"请输入要查询的数据",Toast.LENGTH_SHORT).show();
                }else {
                            ...
                            .execute(new StringCallback() {
                                ...
                                public void onSuccess(String s, Call call, Response response) {
                                    ...
                                    if(state.equals("1")){
                                        ...
                                        list.removeFooterView(view_more);
                                        Toast.makeText(Lihuoyuan_Activity.this,"暂无查询数据",Toast.LENGTH_SHORT).show();
                                    }
...
//                    startActivity(intent);
    ...
    private void saomiao() {
        btn_saomiao.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //转页面
                Intent intent = new Intent(Lihuoyuan_Activity.this,Pd_searchActivity.class);
    ...
    private void setListeners() {
        if (totalCount > 10) {
            // listView设置滑动简监听
            list.setOnScrollListener(Lihuoyuan_Activity.this);
        } else {
